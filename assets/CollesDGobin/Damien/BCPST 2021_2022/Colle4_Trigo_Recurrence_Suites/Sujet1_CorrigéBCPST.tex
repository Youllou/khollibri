...
\fancyhead[RO,RE]{\slshape \textbf{Corrigé - Colle 4 (Sujet 1)}}
...
Soit $a\geqslant 0$. Pour tout entier naturel $n$, $(1+a)^n\geqslant 1+an$.
\end{exo}
...
%Chapitre : Suites réelles
La suite 
\[ u_n= \left(2 \sin \left( \frac{1}{n} \right) + \frac{3}{4} \cos(n)\right)^n\]
converge-t-elle vers une valeur réelle lorsque $n$ tend vers $+\infty$. Si non, pourquoi, si oui, vers quelle valeur ?
\end{exo}

\begin{sol}
On sait que, pour tout $n$, on a $|\cos(n)| \leqslant 1$. D'autre part, puisque $\sin\left( \frac{1}{n} \right)$ tend vers $0$, il existe $1 \geqslant 0$ tel que, pour tout $n \geqslant A$, on ait $\left| \sin \left( \frac{1}{n} \right) \right| \leqslant \frac{1}{16}$. Ainsi, pour $n \geqslant A$, on a 
\[ \left|2 \sin \left( \frac{1}{n} \right) + \frac{3}{4} \cos(n) \right| \leqslant 2 \times \frac{1}{16} + \frac{3}{4} \times 1 = \frac{7}{8}.\]
Ainsi, on a démontré que pour tout $n \geqslant A$, on a 
\[ |u_n| \leqslant \left(\frac{7}{8} \right)^n.\]
Par le théorème d'encadrement des limites, $(u_n)$ converge vers $0$.
\end{sol}
